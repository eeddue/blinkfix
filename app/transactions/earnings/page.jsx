...
function Earnings() {
  ...
  return (
    <div className="">
        ...
        <table className="w-full overflow-x-scroll">
          <thead>
            <tr className="w-full flex text-white rounded-md bg-[#706462] py-2">
              ...
              <th className="w-50">Tips</th>
              <th className="flex-1">Recipes</th>
          ...
          <tbody>
            {users.map((user, i) => (
              ...
              >
                ...
                <td className="flex-1 text-center text-lg">$100</td>
                <td className="w-50 text-center text-lg">$50</td>
                <td className="flex-1 text-center text-lg">$50</td>
      ...
      <div className="lg:hidden pb-[100px]">
        {users.map((user, i) => (
          ...
          >
            ...
            <p className="md:text-lg">Tips : $50</p>
            <p className="md:text-lg">Tips : $50</p>
      ...
      <Modal open={open}>
        <Box>
          <TransactionModal isEarning={true} setOpen={setOpen} />
        </Box>
      </Modal>
    </div>
  );
